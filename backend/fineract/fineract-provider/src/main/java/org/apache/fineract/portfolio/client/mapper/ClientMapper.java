...
public interface ClientMapper {
    ...
    @Mapping(target = "employmentStatus", source = "source", qualifiedByName = "clientEmploymentStatusCode")
    ...
    @Mapping(target = "employmentStatusOptions", ignore = true)
    ...
    @Mapping(target = "employmentStatusId", ignore = true)
    ...
    @Named("clientEmploymentStatusCode")
    default CodeValueData clientEmploymentStatusCode(Client client) {
        final CodeValue code = client.getEmploymentStatus();
        if (code == null) {
            return null;
        }
        return CodeValueData.instance(code.getId(), code.getLabel());
