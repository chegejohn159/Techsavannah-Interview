...
public class ClientWritePlatformServiceJpaRepositoryImpl implements ClientWritePlatformService {
    ...
    public CommandProcessingResult createClient(final JsonCommand command) {
        ...
        try {
            ...
            CodeValue employmentStatus = null;
            final Long employmentStatusId = command.longValueOfParameterNamed(ClientApiConstants.employmentStatusIdParamName);
            if (employmentStatusId != null) {
                employmentStatus = this.codeValueRepository.findOneByCodeNameAndIdWithNotFoundDetection(ClientApiConstants.EMPLOYMENT_STATUS, employmentStatusId);
            }
            ...
            final String employerName = command.stringValueOfParameterNamed(ClientApiConstants.employerParamName);
            ...
            final Client newClient = Client.instance(currentUser, status, clientOffice, clientParentGroup, accountNo, firstname, middlename,
                    ...
                    isStaff, employerName, employmentStatus);
