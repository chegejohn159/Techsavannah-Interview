...
public interface GroupRepository extends JpaRepository<Group, Long>, JpaSpecificationExecutor<Group> {
    ...
    @Query("SELECT COUNT(c) FROM Group g JOIN g.groupSignatories c WHERE g.id = :groupId AND c.id = :clientId")
    int countByGroupIdAndClientId(@Param("groupId") Long groupId, @Param("clientId") Long clientId);
}
