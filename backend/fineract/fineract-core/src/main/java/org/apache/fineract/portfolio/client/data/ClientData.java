...
public final class ClientData implements Comparable<ClientData>, Serializable {
    ...
    private CodeValueData employmentStatus;
    ...
    private Collection<CodeValueData> employmentStatusOptions;
    ...
    public static ClientData importClientEntityInstance(Long legalFormId, Integer rowIndex, String fullname, Long officeId,
        ...
        return new ClientData(legalFormId, rowIndex, fullname, null, null, null, submittedOnDate, activationDate, active, externalId,
                officeId, staffId, mobileNo, dateOfBirth, clientTypeId, null,null, clientClassificationId, null, address, clientNonPersonDetails,
                locale, dateFormat);
    }
    ...
    public static ClientData importClientPersonInstance(Long legalFormId, Integer rowIndex, String firstname, String lastname,
            ...
            Long staffId, String mobileNo, LocalDate dob, Long clientTypeId, Long genderId,Long employmentStatusId, Long clientClassificationId, Boolean isStaff,
        ...
        return new ClientData(legalFormId, rowIndex, null, firstname, lastname, middlename, submittedOn, activationDate, active, externalId,
                officeId, staffId, mobileNo, dob, clientTypeId, genderId,employmentStatusId, clientClassificationId, isStaff, address, null, locale,
                dateFormat);
    }
    ...
    private ClientData(Long legalFormId, Integer rowIndex, String fullname, String firstname, String lastname, String middlename,
            ...
            String mobileNo, LocalDate dob, Long clientTypeId, Long genderId,Long employmentStatusId, Long clientClassificationId, Boolean isStaff,
    ...
    public static ClientData template(final Long officeId, final LocalDate joinedDate, final Collection<OfficeData> officeOptions,
            ...
            final Collection<CodeValueData> genderOptions,final Collection<CodeValueData> employmentStatusOptions, final Collection<SavingsProductData> savingProductOptions,
        ...
        final String employerName = null;
        ...
        final CodeValueData employmentStatus = null;
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename,employerName, lastname, fullname, displayName, externalId, mobileNo, emailAddress, dateOfBirth, gender,employmentStatus, joinedDate, imageId,
                staffId, staffName, officeOptions, groups, staffOptions, narrations, genderOptions,employmentStatusOptions, timeline, savingProductOptions,
    ...
    public static ClientData templateOnTop(final ClientData clientData, final ClientData templateData) {
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.employerName, clientData.lastname, clientData.fullname, clientData.displayName, clientData.externalId, clientData.mobileNo,
                clientData.emailAddress, clientData.dateOfBirth, clientData.gender,clientData.employmentStatus, clientData.activationDate, clientData.imageId,
                clientData.staffId, clientData.staffName, templateData.officeOptions, clientData.groups, templateData.staffOptions,
                templateData.narrations, templateData.genderOptions, clientData.employmentStatusOptions, clientData.timeline, templateData.savingProductOptions,
    ...
    public static ClientData templateWithSavingAccountOptions(final ClientData clientData,
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.narrations, clientData.genderOptions,clientData.employmentStatusOptions, clientData.timeline, clientData.savingProductOptions,
    ...
    public static ClientData clientIdentifier(final Long id, final String accountNo, final String firstname, final String middlename,
        ...
        final Collection<CodeValueData> employmentStatusOptions = null;
        final ClientTimelineData timeline = null;
        ...
        final Set<ClientCollateralManagementData> clientCollateralManagements = null;
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename,employerName, lastname, fullname, displayName, externalId, mobileNo, emailAddress, dateOfBirth, gender,employmentStatus, activationDate,
                imageId, staffId, staffName, allowedOffices, groups, staffOptions, closureReasons, genderOptions,employmentStatusOptions, timeline,
    ...
    public static ClientData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
            ...
            final String firstname, final String middlename, final String employerName, final String lastname, final String fullname, final String displayName,
            final ExternalId externalId, final String mobileNo, final String emailAddress, final LocalDate dateOfBirth,
            final CodeValueData gender,final CodeValueData employmentStatus, final LocalDate activationDate, final Long imageId, final Long staffId, final String staffName,
    ...
    private ClientData(final String accountNo, final EnumOptionData status, final CodeValueData subStatus, final Long officeId,
            ...
            final Collection<StaffData> staffOptions, final Collection<CodeValueData> narrations,
            final Collection<CodeValueData> genderOptions, final Collection<CodeValueData> employmentStatusOptions, final ClientTimelineData timeline,
        ...
        this.employerName = StringUtils.defaultIfEmpty(employerName, null);
        this.externalId = externalId;
