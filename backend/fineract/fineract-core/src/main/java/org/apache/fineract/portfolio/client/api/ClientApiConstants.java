...
//    public static final String employerName = "employerName";
    public static final String employerParamName = "employerName";
    ...
    public static final String employmentStatusIdParamName = "employmentStatusId";
    public static final String employmentStatusParamName = "employmentStatus";
    ...
    protected static final Set<String> CLIENT_RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(idParamName, accountNoParamName,
            ...
            legalFormParamName, clientNonPersonDetailsParamName, isStaffParamName, employmentStatusParamName, employerParamName));
