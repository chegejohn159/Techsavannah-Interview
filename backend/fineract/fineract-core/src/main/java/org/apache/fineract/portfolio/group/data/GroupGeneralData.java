...
public class GroupGeneralData implements Serializable {
    ...
    private final Collection<ClientData> groupSignatories;
    ...
    public static GroupGeneralData importInstance(String groupName, List<ClientData> clientMembers, List<ClientData> groupSignatories, LocalDate activationDate,
        ...
        return new GroupGeneralData(groupName, clientMembers, groupSignatories, activationDate, submittedOnDate, active, externalId, officeId, staffId,
                centerId, rowIndex, locale, dateFormat);
    }

    private GroupGeneralData(String name, List<ClientData> clientMembers,List<ClientData> groupSignatories, LocalDate activationDate, LocalDate submittedOnDate,
        ...
        this.groupSignatories = groupSignatories;
    ...
    public static GroupGeneralData lookup(final Long groupId, final String accountNo, final String groupName) {
        ...
        final Collection<ClientData> groupSignatories = null;
        ...
        return new GroupGeneralData(groupId, accountNo, groupName, null, null, null, null, null, null, null, null, null, null, null,
                clientMembers,groupSignatories, null, null, null, null, null, groupRoles, null, null, null, null, closureReasons, null);
    }
    ...
    public static GroupGeneralData template(final Long officeId, final Long centerId, final String accountNo, final String centerName,
        ...
        return new GroupGeneralData(null, accountNo, null, null, null, null, officeId, null, centerId, centerName, staffId, staffName, null,
                null, clientMembers,groupSignatories, null, centerOptions, officeOptions, staffOptions, clientOptions, groupRoles, availableRoles, null,
    ...
    public static GroupGeneralData withTemplate(final GroupGeneralData templatedGrouping, final GroupGeneralData grouping) {
        return new GroupGeneralData(grouping.id, grouping.accountNo, grouping.name, grouping.externalId, grouping.status,
                ...
                grouping.staffName, grouping.hierarchy, grouping.groupLevel, grouping.clientMembers,grouping.groupSignatories, grouping.activeClientMembers,
    ...
    public static GroupGeneralData withAssocations(final GroupGeneralData grouping, final Collection<ClientData> membersOfGroup,final Collection<ClientData> groupSignatories,
        ...
        return new GroupGeneralData(grouping.id, grouping.accountNo, grouping.name, grouping.externalId, grouping.status,
                grouping.activationDate, grouping.officeId, grouping.officeName, grouping.centerId, grouping.centerName, grouping.staffId,
                grouping.staffName, grouping.hierarchy, grouping.groupLevel, membersOfGroup, groupSignatories, activeClientMembers, grouping.centerOptions,
    ...
    public static GroupGeneralData instance(final Long id, final String accountNo, final String name, final String externalId,
        ...
        return new GroupGeneralData(id, accountNo, name, externalId, status, activationDate, officeId, officeName, centerId, centerName,
                staffId, staffName, hierarchy, groupLevel, clientMembers,groupSignatories, activeClientMembers, centerOptions, officeOptions, staffOptions,
    ...
    private GroupGeneralData(final Long id, final String accountNo, final String name, final String externalId, final EnumOptionData status,
            ...
            final Collection<ClientData> clientMembers,final Collection<ClientData> groupSignatories, final Collection<ClientData> activeClientMembers,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(accountNo, that.accountNo) && Objects.equals(name, that.name)
                ...
                && CollectionUtils.isEqualCollection(groupSignatories, that.groupSignatories)
    ...
    public int hashCode() {
        return Objects.hash(id, accountNo, name, externalId, status, active, activationDate, officeId, officeName, centerId, centerName,
                staffId, staffName, hierarchy, groupLevel, clientMembers,groupSignatories, activeClientMembers, groupRoles, calendarsData,
